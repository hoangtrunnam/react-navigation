...
export function TabBar({
  ...
  const translateX = useDerivedValue(() => {
    ...
    const baseValue = Platform.OS === 'android' && direction === 'rtl' ? getMaxScrollDistance(tabBarWidth, layout.width) + scrollAmount.value * -1 : scrollAmount.value;
  ...
  }, [reanimatedPosition, navigationState, options, activeColor, inactiveColor, pressColor, pressOpacity, isWidthDynamic, tabStyle, layout, routes, scrollEnabled, tabWidths, contentContainerStyle, gap, android_ripple, renderTabBarItem, onTabPress, jumpTo, onTabLongPress]);
